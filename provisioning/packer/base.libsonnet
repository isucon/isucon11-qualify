  ...
  common_provisioners:: {
    ...
    configurate_ansible: {
      ...
      inline: [
        ...
        'sudo cp /dev/shm/files/tls-cert.pem /dev/shm/ansible/roles/contestant/files/tmp/isucon11-qualify/extra/jiaapi-mock/',
        'sudo cp /dev/shm/files/tls-key.pem /dev/shm/ansible/roles/contestant/files/tmp/isucon11-qualify/extra/jiaapi-mock/',
        'sudo cp /dev/shm/files/tls-cert.pem /dev/shm/ansible/roles/bench/files/',
        'sudo cp /dev/shm/files/tls-key.pem /dev/shm/ansible/roles/bench/files/',
