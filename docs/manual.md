...
選手は主催者へ質問を送信することができます。質問は競技内容・マニュアル・レギュレーション等に対する疑問点・明確にしたい事項の確認や、サーバー障害などのトラブル報告・サポート依頼に利用することができるが、これに限りません。ただし、事前にお知らせしているように、競技時間中 AWS クレジットの適用についての質問・サポートは対象外となります。
